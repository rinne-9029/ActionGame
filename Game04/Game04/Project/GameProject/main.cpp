...
void Init(void)
{
	...
	CInput::SetButton(0, CInput::eButton6, VK_SPACE);
	...
	//画像読み込み
	ADD_RESOURCE("Player", CImage::CreateImage("Image/submarin.png"));
	ADD_RESOURCE("Enemy", CImage::CreateImage("Image/same.png"));
	ADD_RESOURCE("Enemy2", CImage::CreateImage("Image/same2.png"));
	ADD_RESOURCE("Enemy3", CImage::CreateImage("Image/same3.png"));
	...
	//ADD_RESOURCE("Trap", CImage::CreateImage("Image/Trap.png",64, 64));
